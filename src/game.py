...
class Game:
    ...
    def player_damage_handler(self):
            ...
            if enemy.weapon:
                ...
                if hasattr(enemy.weapon, "bullet_group"):
                    if pg.sprite.spritecollide(self.player, enemy.weapon.bullet_group, True):
                        self.player.health - 1
            self.camera.render_entity(enemy)

    def render_hud(self):
        self.screen.blit(self.player.health.bar, (33,30))
        self.font.render(self.screen, f"sobreviveu: {self._time_now//1000}s", (33,90))
    ...
    def run(self, delta_time):
        ...
        self.update()
        self.spawn_enemies()
        self.player_damage_handler()
        self.enemy_damage_handler()
